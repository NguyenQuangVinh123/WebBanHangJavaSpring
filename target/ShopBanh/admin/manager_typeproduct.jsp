        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <a href="${root}/admin/insert_typeproduct.jsp">Thêm danh mục</a>
                ...
                <table class="data">
                    ...
                    <center>
                        <a href="${root}/admin/update_typeproduct.jsp?command=update&id_type_product=<%=c.getId_type_product()%>">Sửa</a>&nbsp;&nbsp; | &nbsp;&nbsp;
